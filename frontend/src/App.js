    ...
    <div className="App bg-dark min-h-screen">
      ...
      <header className={`header fixed w-full z-50 py-4 px-6 transition-all duration-300 ${isScrolled ? 'scrolled' : ''}`}>
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <a href="#home" className="text-3xl md:text-4xl font-display font-bold text-white">David Strejc</a>
        ...
        <div className="section hero-content grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="reveal md:col-span-5 z-10 order-1 md:order-2 mb-8 md:mb-0">
            <div className="relative mx-auto">
              ...
              {/* White Background with photo as background */}
              <div 
                className="relative bg-white overflow-hidden shadow-md rounded-[40px_25px_40px_25px]" 
                style={{ 
                  width: '100%', 
                  maxWidth: '419px', 
                  height: '621px',
              ...
              >
                {/* Overlay gradient */}
                <div className="absolute inset-0 bg-gradient-to-b from-white/0 via-white/0 to-primary/10"></div>
